...
class Net(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(6, 784)
        self.fc2 = nn.Linear(784, 520)
        self.fc3 = nn.Linear(520, 320)
...
Fish_Data= pd.read_csv('Fish.csv', sep='\t')  #pandas로 데이터 불러오기 구분자가 탭으로 되어있어서 sep="\t" 추가함
